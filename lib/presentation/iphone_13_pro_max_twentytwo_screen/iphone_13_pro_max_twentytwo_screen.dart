import 'models/iphone_13_pro_max_twentytwo_model.dart';
...
import 'provider/iphone_13_pro_max_twentytwo_provider.dart';

class Iphone13ProMaxTwentytwoScreen extends StatefulWidget {
  const Iphone13ProMaxTwentytwoScreen({Key? key}) : super(key: key);

  @override
  Iphone13ProMaxTwentytwoScreenState createState() =>
      Iphone13ProMaxTwentytwoScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => Iphone13ProMaxTwentytwoProvider(),
        child: Iphone13ProMaxTwentytwoScreen());
  }
}

class Iphone13ProMaxTwentytwoScreenState
    extends State<Iphone13ProMaxTwentytwoScreen> {
  @override
  void initState() {
    super.initState();
  }
