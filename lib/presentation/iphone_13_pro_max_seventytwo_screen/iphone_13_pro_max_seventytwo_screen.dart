import 'models/iphone_13_pro_max_seventytwo_model.dart';
...
import 'provider/iphone_13_pro_max_seventytwo_provider.dart';

class Iphone13ProMaxSeventytwoScreen extends StatefulWidget {
  const Iphone13ProMaxSeventytwoScreen({Key? key}) : super(key: key);

  @override
  Iphone13ProMaxSeventytwoScreenState createState() =>
      Iphone13ProMaxSeventytwoScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => Iphone13ProMaxSeventytwoProvider(),
        child: Iphone13ProMaxSeventytwoScreen());
  }
}

class Iphone13ProMaxSeventytwoScreenState
    extends State<Iphone13ProMaxSeventytwoScreen> {
  @override
  void initState() {
    super.initState();
  }
