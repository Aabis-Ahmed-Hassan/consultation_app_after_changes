import 'models/iphone_13_pro_max_seventyfour_model.dart';
...
import 'provider/iphone_13_pro_max_seventyfour_provider.dart';

class Iphone13ProMaxSeventyfourScreen extends StatefulWidget {
  const Iphone13ProMaxSeventyfourScreen({Key? key}) : super(key: key);

  @override
  Iphone13ProMaxSeventyfourScreenState createState() =>
      Iphone13ProMaxSeventyfourScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => Iphone13ProMaxSeventyfourProvider(),
        child: Iphone13ProMaxSeventyfourScreen());
  }
}

class Iphone13ProMaxSeventyfourScreenState
    extends State<Iphone13ProMaxSeventyfourScreen> {
  @override
  void initState() {
    super.initState();
  }
