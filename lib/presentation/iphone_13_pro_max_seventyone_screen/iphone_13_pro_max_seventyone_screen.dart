import '../iphone_13_pro_max_seventyone_screen/widgets/chipview4_item_widget.dart';
import 'models/chipview4_item_model.dart';
import 'models/iphone_13_pro_max_seventyone_model.dart';
...
import 'provider/iphone_13_pro_max_seventyone_provider.dart';

class Iphone13ProMaxSeventyoneScreen extends StatefulWidget {
  const Iphone13ProMaxSeventyoneScreen({Key? key}) : super(key: key);

  @override
  Iphone13ProMaxSeventyoneScreenState createState() =>
      Iphone13ProMaxSeventyoneScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => Iphone13ProMaxSeventyoneProvider(),
        child: Iphone13ProMaxSeventyoneScreen());
  }
}

class Iphone13ProMaxSeventyoneScreenState
    extends State<Iphone13ProMaxSeventyoneScreen> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget _buildCalendar(BuildContext context) {
    return Align(
        ...
        child: Consumer<Iphone13ProMaxSeventyoneProvider>(
        ...
        child: Consumer<Iphone13ProMaxSeventyoneProvider>(
          ...
          return Wrap(
              ...
              children: List<Widget>.generate(
                  provider.iphone13ProMaxSeventyoneModelObj.chipview4ItemList
                      .length, (index) {
                Chipview4ItemModel model = provider
                    .iphone13ProMaxSeventyoneModelObj.chipview4ItemList[index];
                return Chipview4ItemWidget(model, onSelectedChipView1: (value) {
